            ...
            <Container maxWidth="md">
                ...
                >
                    <Box
                        ...
                        top={{md:50,sm:100}}
                    >
                        <img width={"100%"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-Ar72XzG589Q5nKh1rCn2LdKaJ0hZ3xOBb71Fatvx0MQQ0Qyy" alt="" />
                    </Box>
                    ...
                    <Box display={{md:"flex",sm:"flex"}} justifyContent={"center"} alignItems={"center"}>
                        <ButtonComp title="Try GenieAi for free" />
                        <Link sx={{
                            display: "flex",
                            alignItems: "center",
                            textDecoration: "none",
