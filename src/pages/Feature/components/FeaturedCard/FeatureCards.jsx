                    ...
                    <Grid item md={3} sm={6}>
                        <Box
                            sx={{
                                ...
                                boxShadow: "rgba(174, 174, 192, 0.3) 5px 5px 10px 0px, rgb(255, 255, 255) -5px -5px 10px 0px, rgb(255, 255, 255) 2px 2px 4px 0px inset, rgba(0, 0, 0, 0.1) -2px -2px 4px 0px inset;",
                                p: { md: 3,sm:2,xs:1 },
                                borderRadius: 2,
                                bgcolor: "white"
